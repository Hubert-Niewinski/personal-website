  ...
  return (
      <nav className="w-full mb-8 sm:mb-12 lg:mb-16" data-test-id="main-navigation">
        <div className="relative">
          ...
          <div className={`hidden md:flex w-full items-center justify-between backdrop-blur-xl px-8 lg:px-16 py-8 shadow-2xl transition-all duration-300 relative ${
            scrolled 
            ...
            <div className="flex items-center space-x-2">
              {navigationItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    {/* Icon */}
                    <div className={`w-6 h-6 transition-colors duration-200 flex-shrink-0 ${
                      isActive 
                    ...
                    {/* Label */}
                    <span className={`text-base font-semibold transition-colors duration-200 whitespace-nowrap ${
                      isActive 
            ...
            <div className="flex items-center space-x-2">
              {/* GitHub */}
              <a href={socialLinks[0].url} target="_blank" rel="noopener noreferrer" className="relative w-10 h-10 rounded-lg overflow-hidden flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label={socialLinks[0].ariaLabel}>
                ...
                <svg className="relative w-5 h-5 text-gray-400 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href={socialLinks[1].url} target="_blank" rel="noopener noreferrer" className="relative w-10 h-10 rounded-lg overflow-hidden flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label={socialLinks[1].ariaLabel}>
                <div className="absolute inset-0 bg-gradient-to-br from-slate-500/5 to-slate-600/5 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition-all duration-300"></div>
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-blue-500/5 to-purple-500/5 blur-xl"></div>
                <svg className="relative w-5 h-5 text-gray-400 group-hover:text-blue-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Email */}
              <a href={socialLinks[2].url} className="relative w-10 h-10 rounded-lg overflow-hidden flex items-center justify-center transition-all duration-300 hover:scale-110 group" aria-label={socialLinks[2].ariaLabel}>
                <div className="absolute inset-0 bg-gradient-to-br from-slate-500/5 to-slate-600/5 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition-all duration-300"></div>
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-br from-blue-500/5 to-purple-500/5 blur-xl"></div>
                <svg className="relative w-5 h-5 text-gray-400 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="md:hidden">
            <div className={`flex items-center justify-between px-6 py-4 backdrop-blur-xl shadow-xl ${
              scrolled 
                ? 'bg-gradient-to-r from-black/20 via-black/30 to-black/20' 
                : 'bg-gradient-to-r from-black/30 via-black/40 to-black/30'
            }`}>
            ...
            {mobileMenuOpen && (
              <div className="absolute top-full left-0 right-0 backdrop-blur-xl bg-black/80 border-t border-white/10 shadow-2xl z-50">
