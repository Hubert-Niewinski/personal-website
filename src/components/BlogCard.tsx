...
export function BlogCard({ post }: BlogCardProps) {
  return (
    <article className="group p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 bg-slate-800/40 border border-slate-700/40 hover:border-slate-600/60 hover:shadow-xl hover:shadow-slate-500/20">
      {/* Category Badge */}
      <div className="mb-4">
      ...
      {/* Excerpt */}
      <p className="text-sm mb-4 line-clamp-3 text-slate-300">{post.excerpt}</p>
