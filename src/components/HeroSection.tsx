    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-8 py-12 lg:py-16" data-test-id="hero-section">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 mb-8 lg:mb-12">
        ...
        <div className="text-center lg:text-left px-4 sm:px-0">
          <h1 className={`text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-slate-200 to-slate-300 bg-clip-text text-transparent text-center lg:text-left mb-6 lg:mb-8`} data-test-id="hero-title">
            Hubert Niewiński
          </h1>
          
          <div className="mb-6" data-test-id="hero-subtitle">
            <p className={`text-lg sm:text-xl lg:text-2xl mb-4 font-semibold text-slate-400 text-balance`}>
            ...
            <p className="text-base sm:text-lg leading-[1.7] max-w-2xl lg:mx-0 mx-auto text-[#C8C8E0] text-pretty">
              Senior Test Automation Engineer and Technical Assessor at Sii Poland. While test automation is my core specialization, 
              I bring hands-on experience in full-stack development, DevOps practices, and AI technologies—skills I actively develop 
              in side projects and continuous learning. Active speaker at IT meetups (meet.js, BiałQA) and company webinars. 
              Toastmasters International member for 5+ years with multiple speech contest wins at club and area levels. Off the court, 
              I&apos;m a huge basketball fan and enthusiastic amateur player—passion level: 100%, talent level: debatable at best.
            </p>
          </div>
        </div>
      </div>
