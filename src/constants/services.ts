...
export const services: Service[] = [
  // PRIMARY EXPERTISE
  {
    ...
    description:
      'Expert test automation services including E2E testing, API testing, and CI/CD integration. Frameworks: Playwright, Cypress, TestCafe, Selenium with custom solutions tailored to your needs.',
    features: [
  ...
  },
  {
    ...
    description:
      'Technical consulting, team training, and code reviews. Helping teams improve testing practices, adopt modern development workflows, and build quality into their process.',
    features: [
  ...
  },
  {
    ...
    title: 'AI & Automation',
    description:
      'I can help depending on project complexity. Testing AI systems, implementing AI-powered tools, and exploring automation possibilities. Practical AI integration for testing and development workflows.',
    features: [
...
export const stats: Stat[] = [
  { value: '10+', label: 'Test Automation Frameworks', delay: '0ms' },
  { value: '10+', label: 'Companies Collaborated', delay: '100ms' },
  { value: '80+', label: 'Technical Assessments', delay: '200ms' },
  { value: '50+', label: 'Toastmasters Speeches', delay: '300ms' },
  { value: '3+', label: 'IT Meetup Talks', delay: '400ms' },
  { value: '5+', label: 'Mentees Guided', delay: '500ms' },
];
