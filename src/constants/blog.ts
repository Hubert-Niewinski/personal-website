...
export const blogCategories = {
  it: {
    ...
    name: 'IT & Development',
    description:
      'Technical articles, tutorials, and insights on software development, testing, and DevOps.',
    icon: 'code',
  },
  speaking: {
    ...
    description:
      'Thoughts on public speaking, presentation tips, and experiences from IT meetups and Toastmasters.',
    icon: 'microphone',
  },
  offtopic: {
...
export const blogPosts: BlogPost[] = [
  // IT & Development Posts
  {
    ...
    category: 'it',
    excerpt:
      'A comprehensive guide to starting your test automation journey with modern tools and frameworks.',
    date: '2025-10-01',
    readTime: '8 min read',
  ...
  },
  {
    ...
    category: 'it',
    excerpt:
      'Learn how to set up a complete CI/CD pipeline using modern DevOps tools and practices.',
    date: '2025-09-15',
  ...
  // Public Speaking Posts
  {
    ...
    category: 'speaking',
    excerpt:
      'Tips and strategies for preparing and delivering your first technical presentation at a meetup.',
    date: '2025-09-05',
    readTime: '6 min read',
  ...
  },
  {
    ...
    category: 'speaking',
    excerpt:
      'My journey in Toastmasters and key lessons learned from competing in speech contests.',
    date: '2025-07-10',
    readTime: '7 min read',
